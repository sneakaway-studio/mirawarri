...
namespace NatCam {
    ...
    /// </summary>
    [Doc(@"CameraDevice")]
    public abstract class CameraDevice : IEquatable<CameraDevice> {
        ...
        public abstract Resolution PreviewResolution { get; set; }
        /// <summary>
        /// Get or set the current photo resolution of the camera
        /// </summary>
        [Doc(@"PhotoResolution")]
        public abstract Resolution PhotoResolution { get; set; }
        /// <summary>
        ...
        public bool Equals (CameraDevice other) {
        ...
        public static implicit operator bool (CameraDevice cam) {
            return cam != null;
        }
