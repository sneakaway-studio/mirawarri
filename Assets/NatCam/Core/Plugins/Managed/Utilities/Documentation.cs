...
namespace NatCamU.Core.Utilities {
    ...
    class Map {
        ...
        descriptions = {
            ...
            CD.NatCamUtilitiesRotateImageTextureDescription,
            CD.NatCamUtilitiesRotateImageBufferDesceription,
            ED.NatCamDetectTextDescription,
            PD.NatCamPreviewBufferManagedDescription,
        },
        summaries = {
            //--Core Spec--
            ...
            CD.NatCamDeviceCameraFramerateSummary,
            CD.NatCamDeviceCameraMaxZoomRatioSummary,
            ED.SaveOrientationMirrorSummary,
            CD.ScaleModeLetterboxSummary,
            CD.NatCamFocuserDescription,
            CD.NatCamFocuserIsTrackingSummary,
            CD.NatCamFocuserStartTrackingSummary,
            CD.NatCamFocuserStopTrackingSummary,
            CD.NatCamPreviewDescription,
            CD.NatCamPreviewApplySummary,
            CD.NatCamUtilitiesDescription,
            CD.NatCamUtilitiesRotateImageTextureSummary,
            CD.NatCamUtilitiesRotateImageBufferSummary,
            ED.NatCamDetectFaceSummary,
            ED.NatCamDetectTextSummary,
            ED.TextDescription,
            ED.TextCtorSummary,
            ED.TextTextSummary,
            ED.TextToStringSummary,
            PD.SaveCallbackDescription,
            PD.ConfigurationDescription,
            PD.ConfigurationKeyframeIntervalSummary,
            PD.ConfigurationBitrateSummary,
            PD.ConfigurationRecordAudioSummary,
            PD.ConfigurationDefaultSummary,
            PD.ConfigurationConfigurationSummary,
            PD.OpenCVBehaviourDescription,
            PD.OpenCVBehaviourTextureSummary,
            PD.OpenCVBehaviourMatrixSummary,
            PD.OpenCVBehaviourOnMatrixSummary,
            PD.OpenCVBehaviourFlushMatrixSummary,
        },
        codes = {
            //--Core Spec--
            ...
            CD.NatCamUtilitiesRotateImageTextureExample,
            CD.NatCamUtilitiesRotateImageBufferExample,
            ED.NatCamDetectFaceExample,
            ED.NatCamDetectTextExample,
            PD.OpenCVBehaviourExample,
        };
