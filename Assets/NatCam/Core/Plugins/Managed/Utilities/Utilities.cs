...
namespace NatCamU.Core.Utilities {
    ...
    public static class Utilities {
        ...
        public static void RotateImage (Texture2D texture, Orientation rotation, IDispatch workerDispatch, IDispatch mainDispatch, PhotoCallback callback) {
            ...
            Action completion = () => {
                if (((int)rotation & 7) % 2 != 0) texture.Resize(height, width);
        ...
        public static void Dimensions (this ResolutionPreset preset, out int width, out int height) {
            switch (preset) {
                ...
                case ResolutionPreset.Medium: width = 640; height = 480; break;
                case ResolutionPreset.Highest: width = 9999; height = 9999; break; // NatCam will pick the resolution closest to this, hence the highest
                case ResolutionPreset.Lowest: width = 50; height = 50; break; // NatCam will pick the resolution closest to this, hence the lowest
